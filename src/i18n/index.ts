...
export const resources = {
  en: {
    translation: {
      ...
      "tools.title": "Tools that we use in our everyday work",
      "tools.git": "Git",
      "tools.github": "GitHub",
      "tools.jira": "JIRA",
      "tools.slack": "Slack",
      "tools.backlog": "Backlog",
      "tools.notion": "Notion",
      "tools.figma": "Figma",
      "tools.adobeXd": "Adobe XD",
      "tools.gather": "Gather",
      "tools.metalife": "Metalife",
      "tools.zoom": "Zoom",
      "tools.googleMeets": "Google Meets",
      "tools.teams": "Teams",
      "tools.asana": "Asana",
      "tech.react": "React.js",
      "tech.next": "Next.js",
  ...
  es: {
    translation: {
      ...
      "tools.title": "Herramientas que usamos en nuestro trabajo diario",
      "tools.git": "Git",
      "tools.github": "GitHub",
      "tools.jira": "JIRA",
      "tools.slack": "Slack",
